        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card card-primary">
              ...
              <div class="card-body">
				...
				<c:out test="${not empty result.atchFileId}"</c:out>
                <hr>
          ...
          <!-- 버튼영역 시작 -->
          <div class="card-body">
            	<a href="btn_list" class="btn btn-primary float-right mr-1">목록</button>
              	<button type="btn_delete" class="btn btn-danger float-right mr-1">삭제</button>
				<button type="btn_update" class="btn btn-warning float-right mr-1 text-white">수정</button>              	
                </div>
          <!-- 버튼영역 끝 -->
          </div><!-- //col-12 -->
        </div><!-- //row -->
...
<%@ include file="../include/footer.jsp" %>
			<form name="frm" method="post" action="<c:url value='/admin/board/List_board.do'/>">
					...
					<input type="hidden" name="atchFileId" value="${result.atchFiledId}">
