  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- 로그인한 사용자표시 sidebar user panel (optional) -->
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<c:url value='/' />resources/dist/img/boxed-bg.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<c:url value='/' />/admin/board_list.do?bbsId=BBSMSTR_BBBBBBBBBBBB" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>게시물 관리</p>
                </a>
              </li>
