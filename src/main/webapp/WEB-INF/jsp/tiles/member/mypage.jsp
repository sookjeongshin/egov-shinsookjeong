	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			...
			<form method="POST" name="mypage_form" action="<c:url value= '/tiles/member/mypage.do' />" class="appForm">
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="password" name="PASSWORD" class="w100p" id="password_lbl" placeholder="비밀번호를 입력해주세요"/></div>
						</li>
							<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content"><input value="${memberVO.PASSWORD_HINT}" type="text" name="PASSWORD_HINT_LBL" class="w100p" id="password_hint" placeholder="암호힌트를 입력해주세요" required/></div>
						</li>
							<li class="clear">
							...
							<div class="app_content radio_area">
								...
								<input value="F" type="radio" name="SEXDSTN_CODE" class="css-radio" id="woman_lbl" <c:out value="${memberVO.SEXDSTN_CODE=='M'?'checked':''}"/>/>
								<label for="woman_lbl">여</label>
							</div>
						</li>
						<li class="clear">
							<label for="email_lbl" class="tit_lbl pilsoo_item">이메일</label>
							<div class="app_content"><input value="${memberVO.EMAIL_ADRES}" type="email" name="EMAIL"" class="w100p" id="email_lbl" placeholder="이메일을 입력해주세요" required/></div>
						</li>
						<li class="clear">
							...
							<div class="app_content"><input value="${memberVO.house_adres}" type="text" name="HOUSE_ADRES" class="w100p" id="house_adres_lbl" placeholder="집주소를 입력해주세요" required/></div>
						</li>
						<li class="clear">
				...
				<input type="hidden" name="EMPLYR_STTUS_CODE" value="${memberVO.EMPLYR}">
